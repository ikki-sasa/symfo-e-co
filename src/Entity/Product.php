...
class Product
{
     ...
     * @Assert\Length(min=3, max=255, minMessage="Le nom du produit doit faire au moins 3 caratères")
     */
    private $name;
    ...
    // public static function laodValidatorMetadata(ClassMetadata $metadata)
    // {
